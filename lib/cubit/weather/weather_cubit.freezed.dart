...
mixin _$WeatherState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<WeatherModel> model) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<WeatherModel> model)? loaded,
...
abstract class _$$LoadedImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<WeatherModel> model});
}
...
class _$LoadedImpl implements _Loaded {
  ...
  @override
  String toString() {
    return 'WeatherState.loaded(model: $model)';
  }
...
abstract class _Loaded implements WeatherState {
  const factory _Loaded(final List<WeatherModel> model) = _$LoadedImpl;

  List<WeatherModel> get model;
  @JsonKey(ignore: true)
  _$$LoadedImplCopyWith<_$LoadedImpl> get copyWith =>
      throw _privateConstructorUsedError;
}
