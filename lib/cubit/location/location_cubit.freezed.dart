...
mixin _$LocationState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<LocationModel> model) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<LocationModel> model)? loaded,
...
abstract class _$$LoadedImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<LocationModel> model});
}
...
abstract class _Loaded implements LocationState {
  const factory _Loaded(final List<LocationModel> model) = _$LoadedImpl;

  List<LocationModel> get model;
  @JsonKey(ignore: true)
  _$$LoadedImplCopyWith<_$LoadedImpl> get copyWith =>
      throw _privateConstructorUsedError;
}
