...
import 'package:weather/widgets/weather_item_nodata.dart';
                      ...
                      return SizedBox(
                        ...
                        child: DropdownFormField<Map<String, dynamic>>(
                          ...
                          onChanged: (dynamic str) {
                            context.read<WeatherCubit>().getData(str["id"]);
                            context
                                .read<CurrentWeatherCubit>()
                                .getData(str["id"]);
                            context.read<CodeCubit>().changeCode(str["id"]);
                ...
                BlocListener<NavbarCubit, int>(
                  listener: (context, state) {
                    if (state == 0) {
                      context
                          .read<WeatherCubit>()
                          .getData(context.read<CodeCubit>().state);
                    } else {
                      context
                          .read<WeatherCubit>()
                          .getDataNextDay(context.read<CodeCubit>().state);
                    }
                  },
                  child: Container(
                    ...
                    child: Row(
                      children: [
                        InkWell(
                            ...
                            child:
                                const NavbarItem(name: "Hari ini", index: 0)),
                        InkWell(
                            onTap: () {
                              context.read<NavbarCubit>().changeIndex(1);
                            },
                            child: const NavbarItem(name: "Besok", index: 1)),
                      ],
                    ),
                  ),
                ),
